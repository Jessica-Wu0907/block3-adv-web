<div pt-5>
  <div class="container">
    <div class="d-flex justify-content-between" style="margin: 20px 0">
      ...
      <a href="?" class="btn btn-primary" style="background-color: green;">Home</a>
        ...
        <div class="card h-100">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
              <a href="?page=dishes" class="btn" style="background-color: pink;">Check</a>
              <a href="?page=adddish" class="btn" style="background-color: green;">Add</a>
            </div>
      ...
      <div class="col-md-4 col-sm-12">
        <div class="card h-100">
          <div class="card-body">
            ...
            <p class="card-text">This is the block for adding and dispaying all the suppliers that
