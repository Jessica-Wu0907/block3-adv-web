...
$ingredient1 = new Ingredient(101, 'Broccoli', 'Vegetable', $supplier1->SupplierID, 1.5);
$ingredient2 = new Ingredient(102, 'Beef', 'Meat', $supplier2->SupplierID, 5.0);

// Create instances of Dishes
$dish1 = new Dish(201, 'Vegetable bean', 'Fresh vegetables');
$dish2 = new Dish(202, 'Salad', 'A variety of fresh beans');
